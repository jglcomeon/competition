...
def output_logits_from_dnn(fields_embeddings, params, is_training):
    ...
    # print(sess.run(fields_embeddings))
...
def model_fn(features, labels, mode, params):
    ...
    eval_metric_ops = {'precision': tf.metrics.precision(labels, probabilities)}
    ...
    train_op = params['optimizer'].minimize(loss, tf.train.get_or_create_global_step())
